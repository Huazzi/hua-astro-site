...
![Proxifier 主界面](./Codex重连5次问题解决方法/image-20260803103234150.png)
...
![代理服务器配置](./Codex重连5次问题解决方法/image-20260803104121888.png)
...
![添加程序到规则](./Codex重连5次问题解决方法/image-20260803105707054.png)

5. 将 Action 选择为刚才配置的代理服务器，例如 `Proxy SOCKS5 127.0.0.1`。

![选择代理服务器](./Codex重连5次问题解决方法/image-20260803105125482.png)
