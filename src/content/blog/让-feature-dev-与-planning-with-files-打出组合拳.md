...
> 适用场景：软件开发，使用 Claude Code 作为 Coding Agent。同样适用于其他语言栈的项目开发。
...
![架构总览](https://cbc25ff.webp.li/blog/feature-dev-planning-architecture.webp)
...
![总结示意图](https://cbc25ff.webp.li/blog/feature-dev-planning-summary.webp)
